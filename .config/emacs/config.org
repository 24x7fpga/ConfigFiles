#+TITLE: Emacs Config
#+AUTHOR: Derek Taylor (DT) updated for my personal use. 
...
#+end_src
 ...
 Create and include a setup file that contains the org mode configuration.
...
- Remember to manually install cmake, libtool and libtool-bin using sudo apt-get install <package name>. If there is any error in running vterm.
