...
;;; Commentary:
;;; warm-night theme created by  in 2023
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:bold t :foreground ,builtin :height 1.5))))
   `(org-level-2 ((,class (:bold nil :foreground ,hd2 :height 1.1))))
   `(org-level-3 ((,class (:bold t :foreground ,hd3))))
   `(org-level-4 ((,class (:bold nil :foreground ,hd4))))
